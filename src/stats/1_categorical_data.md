...
- **Nominal variables** have no intrinsic order. Gender and country of origin are nominal.
- **Ordinal variables** have an explicit order. Education level and customer-satisfaction ratings are ordinal.
...
- **Median:** the middle ordered value, or the mean of the two middle values when the count is even.
...
- **Purpose:** Compare category frequencies across groups.
- **Example:** A table of students by gender and grade level can show each gender's percentage within each grade, or each grade's percentage within each gender.
...
- **Usefulness:** They make similarities and differences visible in probability, logic, statistics, and set theory.
